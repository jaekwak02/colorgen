...
function ColorThemeDemo({}) {
	...
	return (
		<DemoPanel theme={theme}>
			<DemoHeader>
				<DemoHeaderTitle className="text-header-2">Color Theme Demo</DemoHeaderTitle>
				<DemoHeaderItem className="text-header-4">Media</DemoHeaderItem>
				<DemoHeaderItem className="text-header-4">Shop</DemoHeaderItem>
				<DemoHeaderItem className="text-header-4">About</DemoHeaderItem>
				<DemoHeaderItem className="text-header-4">Contact</DemoHeaderItem>
				<svg viewBox="0 0 100 100" style={{ width: 30, height: 30 }}>
					<polygon points="0,92.5 50,7.5 100,92.5" fill="var(--color-tertiary-light)" />
				</svg>
			</DemoHeader>
			...
			<DemoContent>
				<DemoMedia>
					...
					<DemoMediaContentGradient1 />
				</DemoMedia>
				<HorizontalLayout columns="repeat(3, minmax(0, 1fr))" padding="var(--spacing-large)">
					<Card>
						<CardHeader>Buttons</CardHeader>
						<CardContent>Testing this thing</CardContent>
						<CardActionsPanel>
							<Button>TEST</Button>
							<Button type="muted">TEST</Button>
					...
					<Card>
						<CardHeader>TEST</CardHeader>
						<CardContent>
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos blanditiis ex quibusdam illo quia optio corporis qui ratione, velit
							soluta!
						</CardContent>
					</Card>

					<Card>
						<CardHeader>A Third Wheel</CardHeader>
